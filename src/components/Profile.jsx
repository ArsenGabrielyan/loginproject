...
export default function ProfilePage(){
     const navigate = useNavigate(), handleLogout = () => {logout(); navigate("/"); users = {};}
     return(
          <>
               ...
               <div className="profile-info">
                    ...
                    <div className="left"><img src={users.file} alt="profile" /></div>
                    <div className="right">
                         ...
                         <div className="info">
                              <p><span className="infoIcon"><Icon icon="uiw:date" /></span> {new Date(users.date).toLocaleDateString()}</p>
